...
| mise à jour le 24 janvier 2010                                               |
| Synthèse de grilles pour jeu de sudoku, version 1 (fr)                       |
| Passage des données en variables JavaScript: result, Grille(9x9) ,Masque(9x9)|
...
/*========= Sorties javascript ===============================================*/
if (strlen($loterie)== 0){
  // une grille valide trouvée
  $result= 'niveau_1';
  // $Grille[$i][$j] $i et $j de 0 à 8
  // $Masque[$i][$j], si =1 le chiffre peut être masqué, si =0 doit être affiché
  if ($tentative== 1){
    //  grille trouvée dès la première tentative
  }
  else{
    // grille trouvée après $tentative tentatives
  }
}
else{
  // Echec, pas de grille valide trouvée
  $result= 'non';
}
